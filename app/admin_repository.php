...
function admin_dashboard_stats(): array
{
    ...
    return admin_dashboard_default_stats([
        ...
        'contact_messages_new' => admin_safe_count($pdo, "SELECT COUNT(*) FROM contact_messages WHERE status = 'NEW'"),
        'contact_messages' => admin_safe_count($pdo, 'SELECT COUNT(*) FROM contact_messages'),
        'services_active' => admin_safe_count($pdo, "SELECT COUNT(*) FROM services WHERE status = 'ACTIVE'"),
