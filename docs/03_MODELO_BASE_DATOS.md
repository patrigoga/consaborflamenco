...
- 2026-09-12: Mega agenda, bloques 3 y 4. Anadida la columna `eventos.acepta_reservas` (BOOLEAN, DEFAULT FALSE) y la tabla `tablao_reservas` (migracion `database/20260912_tablao_reservas.sql`). Anadida la tabla `tienda_productos`, escaparate sin carrito con baja logica (migracion `database/20260912_tienda_productos.sql`). Detalle en `docs/18_MEGA_AGENDA.md`.
