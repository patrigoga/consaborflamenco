...
- 2026-08-23: "Mi pagina web" se organiza como hub de tarjetas con una pantalla por bloque (slider de cabecera, galeria, videos, agenda, actualidad, redes sociales y contacto), con migas de pan para volver al hub y al panel. Los contadores de cada tarjeta salen del propio contenido guardado. Los indicadores de cada pantalla van arriba y con un tinte distinto por posicion.
